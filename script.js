...
function renderResult() {
  ...
  report.innerHTML += `
    ...
    <p style="line-height:1.8;">
      本報告由夢航公司意識對映模組 EULYSIA™ 協同生成，根據您的心理答題結果進行多維度風險評估與適配推算。
      本評估不僅反映您目前的情緒韌性與人格結構，也揭示了您在「作為未來人載體」時可能面臨的身心挑戰。
      時空旅行雖為 2201 年的重要文明活動之一，但作為原木載體的人類，仍需承擔由他者意識進入體內所產生的壓力與重組風險。
